export const initEditor = (monacoEditor: any) => {
    ...
    monacoEditor.languages.setMonarchTokensProvider("mermaid", {
        ...
        tokenizer: {
            root: [
                ...
                [
                    /^\s*(flowchart|flowchart-v2|graph)/m,
                    "typeKeyword",
                    "flowchart",
                ],
            ...
            gitGraph: [
                ...
                [
                    /option(?=s)/,
                    { token: "typeKeyword", next: "optionsGitGraph" },
                ],
                [
            ...
            journey: [
                ...
                [
                    /(^\s*.+?)(:)([^:]*?)$/,
                    ["string", "delimiter.bracket", "variable"],
                ],
                [/%%[^$]([^%]*(?!%%$)%?)*$/, "comment"],
            ],
            gantt: [
            ...
            stateDiagram: [
                ...
                [
                    /note[^:]*$/,
                    { token: "typeKeyword", next: "stateDiagramNote" },
                ],
